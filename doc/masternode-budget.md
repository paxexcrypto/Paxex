...
Paxex now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<paxex_address\> \<monthly_payment_paxex\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ PAXEX, _12_ times over the course of a year totaling _24000_ PAXEX.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<paxex_address\> \<monthly_payment_paxex\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` PAXEX.
 ...
 * vote-many          - Vote on a Paxex initiative
 * vote-alias         - Vote on a Paxex initiative
 * vote               - Vote on a Paxex initiative/budget
