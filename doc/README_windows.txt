...
Intro
-----
Paxex (PAXEX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Paxex utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run paxex-qt.exe.

Paxex Core is the original Paxex client and it builds the backbone of the network.
However, it downloads and stores the entire history of Paxex transactions;
