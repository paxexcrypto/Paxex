...
This mechanism has been integrated into Bitcore-Node-Paxex which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/paxex/insight-api-paxex#web-socket-api](https://github.com/paxex/insight-api-paxex#web-socket-api)
* API: [https://github.com/paxex/insight-api-paxex#swifttx-transactions](https://github.com/paxex/insight-api-paxex#swifttx-transactions)
...
By default, the Paxex Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Paxex Core daemon:
