...
In order to support loading of multiple wallets in paxex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is paxex.cpp.
...
Changes to paxex.cpp
----------------------
paxex.cpp is the entry point into paxex-qt, and as such, will require some minor modifications to provide hooks for
