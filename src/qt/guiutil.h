...
/** Utility functions used by the Paxex Qt UI.
 */
namespace GUIUtil
{
...
// Render PAXEX addresses in monospace font
...
// Parse "paxex:" URI into recipient object, return true on successful parsing
