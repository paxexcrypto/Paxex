                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Paxex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PAXEX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and paxex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Paxex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Paxex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Paxex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PAXEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PAXEX addresses"));
    ...
    openAction->setStatusTip(tr("Open a paxex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Paxex Core help message to get a list with possible Paxex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Paxex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Paxex network", "", count));
}
...
{
    QString strTitle = tr("Paxex Core"); // default title
