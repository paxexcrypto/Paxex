...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Paxex Core paxex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  paxex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded paxex transaction") + "\n" +
                               "  paxex-tx [options] -create [commands]   " + _("Create hex-encoded paxex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded paxex transaction
