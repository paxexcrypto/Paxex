Contributing to Paxex Core
==================================

The Paxex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Paxex Core project, and is not to be
confused with overall Paxex Network Protocol consensus changes.

Whether a pull request is merged into Paxex Core rests with the project merge
...
Patches that change Paxex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Paxex consensus, it must have been
...
The project leader is the release manager for each Paxex Core release.
