...
RESOURCES += src/qt/paxex.qrc src/qt/paxex_locale.qrc

TRANSLATIONS += src/qt/locale/paxex_bg.ts \
                src/qt/locale/paxex_de.ts \
                src/qt/locale/paxex_en.ts \
                src/qt/locale/paxex_es.ts \
                src/qt/locale/paxex_fi.ts \
                src/qt/locale/paxex_fr.ts \
                src/qt/locale/paxex_it.ts \
                src/qt/locale/paxex_ja.ts \
                src/qt/locale/paxex_pl.ts \
                src/qt/locale/paxex_pt.ts \
                src/qt/locale/paxex_ru.ts \
                src/qt/locale/paxex_sk.ts \
                src/qt/locale/paxex_sv.ts \
                src/qt/locale/paxex_vi.ts \
                src/qt/locale/paxex_zh_CN.ts \
                src/qt/locale/paxex_zh_TW.ts
